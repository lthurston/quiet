...
func TestSpliceIntoMiddle(t *testing.T) {
	...
	splicer.SpliceInto(3, 8, spliceContent, reader, &buffer)
...
func TestSpliceIntoBeginning(t *testing.T) {
	reader := strings.NewReader(contents)
	var buffer bytes.Buffer
	splicer.SpliceInto(0, 7, spliceContent, reader, &buffer)
	splice := buffer.String()
...
func TestSpliceIntoEnd(t *testing.T) {
	reader := strings.NewReader(contents)
	var buffer bytes.Buffer
	splicer.SpliceInto(8, 0, spliceContent, reader, &buffer)
	splice := buffer.String()
